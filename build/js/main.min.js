...
},{"./modules/coaches-slider":2,"./modules/form-validate/form":4,"./modules/init-tabs":10,"./modules/modals/init-modals":11,"./modules/play-video":13,"./modules/reviews-slider":14,"./modules/tabs":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var crew = document.querySelector('.coaches');
...
var initCoachesSwiper = function initCoachesSwiper() {
  if (crew) {
    ...
    coachesSwiper.init();
    var coachesSlides = Array.from(crew.querySelector('.swiper-wrapper').children);
    var setTabIndex = function setTabIndex() {
      coachesSlides.forEach(function (item) {
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    ...
    value: function _messageTemplate(message, state) {
      ...
      return "<div class=\"input-message ".concat(cssClass, "\">").concat(message, "</div>");
    }
  }, {
    key: "removeMessage",
...
},{"./tabs":15}],11:[function(require,module,exports){
"use strict";
...
var video = document.querySelector('.about__video-js');
var link = document.querySelector('.about__video-link');
var button = document.querySelector('.about__video-button');
